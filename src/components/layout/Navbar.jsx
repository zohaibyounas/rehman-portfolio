            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex justify-between items-center h-16">
                    ...
                    <div className="flex-shrink-0 flex items-center">
                        <a href="#" className="font-bold text-2xl text-slate-800 dark:text-white">
                ...
                <div className="md:hidden bg-white dark:bg-slate-900 border-b border-slate-200 dark:border-slate-800 transition-colors duration-300">
                    <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
                        ...
                        <div className="pt-4 px-3">
                            <Button variant="primary" className="w-full" onClick={() => { setIsOpen(false); window.location.href = '#contact'; }}>
                                Hire Me
                            </Button>
                        </div>
                    </div>
